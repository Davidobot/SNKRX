...
function init()
  ...
  song1 = Sound('Kubbi - Ember - 01 Pathfinder.ogg', {tags = {music}}, true)
  song2 = Sound('Kubbi - Ember - 02 Ember.ogg', {tags = {music}}, true)
  song3 = Sound('Kubbi - Ember - 03 Firelight.ogg', {tags = {music}}, true)
  song4 = Sound('Kubbi - Ember - 04 Cascade.ogg', {tags = {music}}, true)
  song5 = Sound('Kubbi - Ember - 05 Compass.ogg', {tags = {music}}, true)
  death_song = Sound('Kubbi - Ember - 09 Formed by Glaciers.ogg', {tags = {music}}, true)
...
function open_options(self)
  ...
  trigger:tween(0.25, _G, {slow_amount = 0}, math.linear, function()
    ...
    self.mouse_button = Button{group = self.ui, x = gw/2 - 109, y = gh - 150, w = (pixul_font:get_text_width('controls: joystick') + 8), force_update = true, button_text = 'controls: ' .. tostring(state.mouse_control and (state.mouse_control == 'point' and 'point' or 'joystick') or 'L/R'), fg_color = 'bg10', bg_color = 'bg',
    action = function(b)
      ui_switch1:play{pitch = random:float(0.95, 1.05), volume = 2*0.5}
